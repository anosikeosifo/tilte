...
import EventCard from '../../events/components/EventCard.js';
import MomentCard from '../../moments/components/MomentCard.js'
import { ICON_SCROLL_LEFT, ICON_SCROLL_RIGHT } from '../../core/constants';
import { WELCOME_VIEW_DATA_GROUPS } from '../../layout/constants';
...
class BoardCategory extends Component {
  ...
  renderData() {
    ...
    switch(this.props.categoryName) {
      case WELCOME_VIEW_DATA_GROUPS.FEATURED_EVENTS:
        categoryItems = this.props.dataset.map(item => (<EventCard key={ item.id } { ...item }/>));
        break;
      case WELCOME_VIEW_DATA_GROUPS.TRENDING_POSTS:
