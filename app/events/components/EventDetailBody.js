...
import { fetchEventDetails } from '../EventActionCreators';
...
import UserCardContainer from '../../users/containers/UserCardContainer';
              ...
              <div className={ `details__header__wrap ${ this.props.scrollState.header }` }>
                <div className='details__header'>
                  ...
                  <section className='event__action__wrap'>
                    <EventActions eventId={ this.props.eventObject.id } isAttending={ this.props.eventObject.isAttending } actionsSet={ this.props.userActions } actor={ this.props.actor } callBacks={ this.props.actionCallbacks }/>
                  </section>
                </div>
