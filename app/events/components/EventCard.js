...
import { EVENT_IMAGE_PLACEHOLDERS } from '../constants';
import { USER_AVATAR_PLACEHOLDER, CURRENCY_SYMBOLS } from '../../core/constants';
          ...
          <figure className={ classes }
            ...
            <section className='event_media_object'>
              <div className='event__img__wrap'>
                <img src={ EVENT_IMAGE_PLACEHOLDERS[0] } alt='' className='event__img'/>
              </div>
